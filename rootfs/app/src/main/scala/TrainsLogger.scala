...
class TrainsLogger(val apiHost: String, val userKey: String, val userSecret: String) {
  import com.tencent.trains.TaskStatus._
  import com.tencent.trains.TaskType._
  import com.tencent.trains.TaskEventType._
  import com.tencent.trains.LogLevel._
  import com.tencent.trains.TrainsServerResponse._
